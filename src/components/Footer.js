...
import { lightB, logopayment } from '../assets'
...
function Footer() {
    ...
    <div className='bg-black text-[#949494] py-20 font-titleFont'>
        <div className='max-w-screen-xl mx-auto grid grid-cols-4'>
            ...
            <div className='flex flex-col gap-4'>
                <img className='w-32' src={lightB} alt="" />
 ...
 <div className='text-base flex flex-col gap-3'>
    <p>MBD,Nagpur, India </p>
    <p>Mobile: +91 7066766507</p>
    <p>Phone: 009889765436</p>
    <p>e-mail: patlep08@gmail.com</p>
 </div>
 </div>
