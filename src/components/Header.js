...
import { logoBazar, logocart } from '../assets'
  ...
  return (
    <div className='w-full h-20 bg-white border-b-[1px] border-b-gray-800 font-titleFont sticky top-0 z-50'>
      <div className='max-w-screen-xl h-full mx-auto flex items-center justify-between'>
        <Link to="/">
        <div>
            <img className='w-28' src={logoBazar} alt="logoBazar" />
        </div>
        </Link>
      <div className='flex items-center gap-8'>
        ...
        <div className='relative'>
            <img className='w-6' src={logocart} alt="cartImg" />
        ...
        <img
         className='w-8 h-8 rounded-full'
          src={
            userInfo 
            ? userInfo.image
            : "https://c1.wallpaperflare.com/preview/418/819/714/mobile-online-dare-shopping-cart-thumbnail.jpg"
          } alt="logo" />
        </Link>
        { userInfo && (
